...
import { Code, Copy, ArrowLeft, BookOpen, Settings, BarChart3, Zap } from "lucide-react";
...
const installationSteps = [
  {
    ...
    description: "Перейдите на страницу создания и укажите название и домен вашего сайта.",
  ...
  },
  {
    ...
    description: "Добавьте код перед закрывающим тегом </body> на всех страницах.",
    action: "Установить код"
  },
  {
    step: 4,
    title: "Проверьте работу",
    description: "Откройте ваш сайт и убедитесь, что данные поступают в панель аналитики.",
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-purple-50 dark:from-slate-950 dark:via-slate-900 dark:to-slate-950">
      ...
      <div className="container mx-auto max-w-6xl px-4 py-16 pt-32">
        <div className="flex items-center gap-4 mb-8">          <Button asChild variant="outline" size="icon">
            <Link href="/">
        ...
        <div className="grid lg:grid-cols-4 gap-6 mb-12">          <Card className="border-0 shadow-lg bg-white/80 dark:bg-slate-800/80 backdrop-blur-sm">
        ...
        <div className="space-y-8">
            ...
            <CardContent className="space-y-6">
              <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-4">
                {installationSteps.map((step) => (
                  <div key={step.step} className="text-center p-4 rounded-lg bg-gray-50 dark:bg-slate-700/50">
          ...
          <Card className="border-0 shadow-lg bg-white/80 dark:bg-slate-800/80 backdrop-blur-sm">
            <CardHeader>
              ...
              <p className="text-gray-600 dark:text-gray-300">
                Добавьте этот код в секцию &lt;head&gt; всех страниц вашего сайта:
              </p>              <div className="bg-gray-900 rounded-lg p-4 relative">
                <Button
                  variant="outline"
                  size="sm"
                  className="absolute top-2 right-2 h-8 px-2"
                  onClick={() => copyToClipboard('<script async src="http://localhost:3000/api/script?id=YOUR_COUNTER_ID"></script>')}
                >
                  <Copy className="h-3 w-3" />
                  {copiedText === '<script async src="http://localhost:3000/api/script?id=YOUR_COUNTER_ID"></script>' ? 'Скопировано!' : ''}
                </Button>
...
{`<script async src="http://localhost:3000/api/script?id=YOUR_COUNTER_ID"></script>`}
              ...
              <p className="text-sm text-gray-600 dark:text-gray-400">
                Замените <code className="bg-gray-200 dark:bg-gray-700 px-1 rounded">YOUR_COUNTER_ID</code> на ID вашего счетчика.
              </p>

              <div className="mt-6">
                <h4 className="font-semibold mb-3 text-gray-800 dark:text-gray-200">Альтернативная установка</h4>
                <p className="text-gray-600 dark:text-gray-300 mb-4">
                  Если вы не можете использовать внешний скрипт, интегрируйте трекинг напрямую:
                </p>
...
(function() {
  ...
  sendData({
    ...
    sessionId: sessionId
          ...
          </Card>          <Card className="border-0 shadow-lg bg-white/80 dark:bg-slate-800/80 backdrop-blur-sm">
            <CardHeader>
              <CardTitle>Отслеживание целей</CardTitle>
            </CardHeader>
            <CardContent className="space-y-4">
              <p className="text-gray-600 dark:text-gray-300">
                Для отслеживания пользовательских событий (целей) отправляйте POST-запросы на API:
              </p>
              <div className="bg-gray-900 rounded-lg p-4">
                <pre className="text-green-400 text-sm overflow-x-auto">
{`// JavaScript пример
...
// - video_play (воспроизведение видео)`}
          ...
          <Card className="border-0 shadow-lg bg-white/80 dark:bg-slate-800/80 backdrop-blur-sm">
            ...
            <CardContent className="space-y-4">
              <div className="space-y-4">                <div className="border border-gray-200 dark:border-gray-700 rounded-lg p-4">
                  <div className="flex items-center gap-2 mb-2">
                    <span className="bg-green-100 dark:bg-green-900/50 text-green-600 dark:text-green-400 px-2 py-1 rounded text-xs font-medium">GET</span>
                ...
                <div className="border border-gray-200 dark:border-gray-700 rounded-lg p-4">
                  <div className="flex items-center gap-2 mb-2">
                    <span className="bg-blue-100 dark:bg-blue-900/50 text-blue-600 dark:text-blue-400 px-2 py-1 rounded text-xs font-medium">POST</span>
          ...
          <Card className="border-0 shadow-lg bg-white/80 dark:bg-slate-800/80 backdrop-blur-sm">
            ...
            <CardContent className="space-y-4">
              <div className="grid md:grid-cols-2 gap-4">                <div className="border border-gray-200 dark:border-gray-700 rounded-lg p-4">
                  <h4 className="font-semibold mb-2">WordPress</h4>
                  <p className="text-sm text-gray-600 dark:text-gray-400 mb-3">
                    Добавьте код в файл header.php вашей темы перед закрывающим тегом &lt;/head&gt; или используйте плагин для вставки кода в заголовок.
                  </p>
                ...
                <div className="border border-gray-200 dark:border-gray-700 rounded-lg p-4">
                  ...
                  <p className="text-sm text-gray-600 dark:text-gray-400 mb-3">
                    Добавьте код в компонент _document.js в секцию Head или используйте next/head.
                  </p>
                  <div className="bg-gray-900 rounded-lg p-2">
                    <code className="text-green-400 text-xs">
                ...
                <div className="border border-gray-200 dark:border-gray-700 rounded-lg p-4">
                  ...
                  <p className="text-sm text-gray-600 dark:text-gray-400 mb-3">
                    Добавьте код в public/index.html в секцию head или создайте компонент Analytics.
                  </p>
                  <div className="bg-gray-900 rounded-lg p-2">
                    <code className="text-green-400 text-xs">
                ...
                <div className="border border-gray-200 dark:border-gray-700 rounded-lg p-4">
                  ...
                  <p className="text-sm text-gray-600 dark:text-gray-400 mb-3">
                    Просто вставьте код в секцию &lt;head&gt; на каждой странице вашего сайта.
                  </p>
                  <div className="bg-gray-900 rounded-lg p-2">
                    <code className="text-green-400 text-xs">
                      &lt;head&gt;...скрипт...&lt;/head&gt;
            ...
            <CardContent className="space-y-4">
              <div className="grid md:grid-cols-2 gap-6">
                <div className="space-y-4">
                  <h4 className="font-semibold text-gray-800 dark:text-gray-200">📊 Основная статистика</h4>
                  ...
                  <h4 className="font-semibold text-gray-800 dark:text-gray-200 pt-4">📈 Графики и визуализация</h4>
                  <ul className="space-y-2 text-sm text-gray-600 dark:text-gray-400">
                ...
                <div className="space-y-4">
                  <h4 className="font-semibold text-gray-800 dark:text-gray-200">🌍 География и устройства</h4>
                  <ul className="space-y-2 text-sm text-gray-600 dark:text-gray-400">
                  ...
                  <h4 className="font-semibold text-gray-800 dark:text-gray-200 pt-4">⚡ Периоды анализа</h4>
                  <ul className="space-y-2 text-sm text-gray-600 dark:text-gray-400">
        ...
        <Card className="bg-gradient-to-r from-blue-600 to-purple-600 border-0 text-white mt-12">
          <CardContent className="p-8 text-center">
            ...
            <p className="mb-6 opacity-90">
              Создайте свой первый счетчик аналитики и получите детальную статистику уже сегодня.
            </p>            <Button asChild size="lg" variant="secondary" className="bg-white text-blue-600 hover:bg-gray-100">
              <Link href="/create">
